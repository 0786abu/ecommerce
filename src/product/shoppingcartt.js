    ...
    <div className='-z-10'>
      <section className="py-24 relative -z-20">
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          ...
          {cart.map((x) => {
            return (
              <div className="grid grid-cols-1 lg:grid-cols-2 min-[550px]:gap-6 border-t border-gray-200 py-6" key={x.id}>
                <div className="flex items-center flex-col min-[550px]:flex-row gap-3 min-[550px]:gap-6 w-full max-xl:justify-center max-xl:max-w-xl max-xl:mx-auto">
                  <div className="img-box"><img src={x.image} alt="product image" className="xl:w-[140px]" /></div>
                  <div className="pro-data w-full max-w-sm">
                    <h5 className="font-semibold text-xl leading-8 text-black max-[550px]:text-center">{x.title}</h5>
                    <p className="font-normal text-lg leading-8 text-gray-500 my-2 min-[550px]:my-3 max-[550px]:text-center">{x.brand}</p>
                    <h6 className="font-medium text-lg leading-8 text-indigo-600 max-[550px]:text-center">RS. {x.price}</h6>
                  </div>
                </div>
                <div className="flex items-center flex-col min-[550px]:flex-row w-full max-xl:max-w-xl max-xl:mx-auto gap-2">
                  <h6 className="font-manrope font-bold text-2xl leading-9 text-black w-full max-w-[176px] text-center">{x.category}</h6>
                  ...
                  <h6 className="text-indigo-600 font-manrope font-bold text-2xl leading-9 w-full max-w-[176px] text-center">RS. {x.price * x.qty}</h6>
          ...
          <div className="bg-gray-50 rounded-xl p-6 w-full mb-8 max-lg:max-w-xl max-lg:mx-auto">
            ...
            <div className="flex items-center justify-between w-full pb-6 border-b border-gray-200">
              <p className="font-normal text-xl leading-8 text-gray-400">Total Quantity</p>
          ...
          <div className="flex items-center flex-col sm:flex-row justify-center gap-3 mt-8">
            <button className="rounded-full py-4 w-full max-w-[280px] flex items-center bg-indigo-50 justify-center transition-all duration-500 hover:bg-indigo-100">
              <Link to='/laptop'><span className="px-2 font-semibold text-lg leading-8 text-indigo-600 cursor-pointer">Continue Shopping</span></Link>
